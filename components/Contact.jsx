    ...
    return <main className="container mx-auto px-4 py-6">
                ...
                <form onSubmit={handleSubmit} className="w-full max-w-lg">
                    <div className="flex items-center mb-4">
                        ...
                        <input type="text" onChange={handleInput} name="name" value={inputs.name??''} id="name" className="border rounded px-2 py-1 w-3/4"/>
                    </div>
                    <div className="flex items-center mb-4">
                        <label htmlFor="email" className="w-1/4">Email:</label>
                        <input type="email" onChange={handleInput} name="email" value={inputs.email??''} id="email" className="border rounded px-2 py-1 w-3/4"/>
                    </div>
                    <div className="flex items-center mb-4">
                        <label htmlFor="message" className="w-1/4">Message:</label>
                        <textarea id="message" onChange={handleInput} name="message" value={inputs.message??''} className="border rounded px-2 py-1 w-3/4" rows="4"></textarea>
                    </div>
